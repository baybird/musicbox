...
var DataService = (function () {
    ...
    function DataService(http) {
        this.http = http;
        this.search_url = "https://itunes.apple.com/search?media=music&term=%s";
        this.musicList = {};
